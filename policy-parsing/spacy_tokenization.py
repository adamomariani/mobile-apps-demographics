...
##################################################################################################
##################################################################################################
###############THE SCRIPT IS USED TO FIND PATTERS WITHIN PROCESSED PRIVACY POLICY TEXTS###########
###########################RESULTS ARE SAVED TO JSON FILE policies_data.json######################
##################################################################################################
##################################################################################################

#Paragraphs are collected when true, only total matches are recorded otherwise
COLLECT_PARAGRAPHS = True

OUTPUT_FILE = 'policies_data.json'
COLLECTION_COUNTS_FILE = 'policies_datacounts.json'

#Each category is mapped to specific words & phrases
patterns = {
    "Location": [
        [{"LOWER": "coarse"}, {"LOWER": {"FUZZY4": "location"}}],
        [{"LOWER": "precise"}, {"LOWER": {"FUZZY4": "location"}}],
        [{"LOWER": {"FUZZY3": "location"}}, {"LOWER": "information"}],
        [{"LOWER": {"FUZZY3": "location"}}, {"LOWER": "info"}],
        [{"LOWER": "gps"}],
        [{"LOWER": {"FUZZY3": "location"}}, {"LOWER": {"FUZZY": "data"}}],
        [{"LOWER": "geographical"}, {"LOWER": "location"}],
        [{"LOWER": {"FUZZY3": "location"}}, {"LOWER": {"FUZZY": "coordinates"}}],
        [{"LOWER": {"FUZZY3": "location"}}, {"LOWER": "tracking"}],
        [{"LOWER": {"FUZZY3": "location"}}, {"LOWER": "history"}],
        [{"LOWER": "geo"}, {"LOWER": "data"}],
        [{"LOWER": "geographical"}, {"LOWER": "data"}],
        [{"LOWER": "geolocation"}],
        [{"LOWER": "localization"}, {"LOWER": "information"}],
        [{"LOWER": "localization"}, {"LOWER": "info"}],
        [{"LOWER": {"FUZZY3": "positioning"}}, {"LOWER": "data"}]
    ],
    "Contact Info": [
        [{"LOWER": "name"}],
        [{"LOWER": "email"}, {"LOWER": {"FUZZY": "address"}}],
        [{"LOWER": "physical"}, {"LOWER": {"FUZZY": "address"}}],
        [{"LOWER": "home"}, {"LOWER": {"FUZZY": "address"}}],
        [{"LOWER": "phone"}, {"LOWER": {"FUZZY": "number"}}],
#        [{"LOWER": "contact"}, {"LOWER": {"FUZZY": "information"}}],   #Exclude since sometimes Trafilatura extract
#        [{"LOWER": "contact"}, {"LOWER": {"FUZZY": "info"}}],          #includes unwanted company contact info
        [{"LOWER": "contact"}, {"LOWER": {"FUZZY": "details"}}],
        [{"LOWER": "contact"}, {"LOWER": {"FUZZY": "address"}}],
        [{"LOWER": "mailing"}, {"LOWER": "address"}]
    ],
    "Identifiers": [
        [{"LOWER": "user"}, {"LOWER": "id"}],
        [{"LOWER": "device"}, {"LOWER": "id"}],
        [{"LOWER": "device"}, {"LOWER": {"FUZZY": "identifiers"}}],
        [{"LOWER": "user"}, {"LOWER": {"FUZZY": "identifiers"}}],
        [{"LOWER": "account"}, {"LOWER": "number"}],
        [{"LOWER": "account"}, {"LOWER": "id"}],
        [{"LOWER": "registration"}, {"LOWER": "id"}],
        [{"LOWER": "ip"}, {"LOWER": {"FUZZY": "address"}}]
    ],
    "Sensitive Info": [
        [{"LOWER": "sensitive"}, {"LOWER": "info"}],
        [{"LOWER": "sensitive"}, {"LOWER": "information"}],
        [{"LOWER": {"FUZZY3": "religious"}}, {"LOWER": {"FUZZY3": "background"}}],
        [{"LOWER": {"FUZZY3": "religious"}}, {"LOWER": {"FUZZY": "faith"}}],
        [{"LOWER": {"FUZZY3": "religious"}}, {"LOWER": {"FUZZY3": "principles"}}],
        [{"LOWER": {"FUZZY3": "religious"}}, {"LOWER": {"FUZZY": "beliefs"}}],
        [{"LOWER": "political"}, {"LOWER": {"FUZZY3": "preference"}}],
        [{"LOWER": "sexual"}, {"LOWER": {"FUZZY3": "orientation"}}],
        [{"LOWER": {"FUZZY3": {"IN": ["sexuality"]}, "NOT_IN": ["security"]}}],
        [{"LOWER": "medical"}, {"LOWER": "history"}],
        [{"LOWER": "genetic"}, {"LOWER": "information"}],
        [{"LOWER": "genetic"}, {"LOWER": "info"}],
        [{"LOWER": "genetic"}, {"LOWER": "data"}],
        [{"LOWER": "biometric"}, {"LOWER": "data"}],
        [{"LOWER": "racial"}, {"LOWER": "information"}],
        [{"LOWER": "racial"}, {"LOWER": "info"}],
        [{"LOWER": "racial"}, {"LOWER": "data"}],
        [{"LOWER": "ethnic"}, {"LOWER": "information"}],
        [{"LOWER": "ethnic"}, {"LOWER": "info"}],
        [{"LOWER": "ethnic"}, {"LOWER": "data"}],
        [{"LOWER": "criminal"}, {"LOWER": {"FUZZY": "record"}}],
        [{"LOWER": "psychological"}, {"LOWER": "data"}]
    ],
    "Financial Info": [
        [{"LOWER": "payment"}, {"LOWER": "info"}],
        [{"LOWER": "payment"}, {"LOWER":  {"FUZZY3": "information"}}],
        [{"LOWER": "payment"}, {"LOWER": "details"}],
        [{"LOWER": "credit"}, {"LOWER": "info"}],
        [{"LOWER": "credit"}, {"LOWER": "score"}],
        [{"LOWER": "credit"}, {"LOWER":  {"FUZZY3": "information"}}],
        [{"LOWER": "financial"}, {"LOWER": "info"}],
        [{"LOWER": "bank"}, {"LOWER": {"FUZZY": "account"}}, {"LOWER": {"FUZZY": "details"}}],
        [{"LOWER": "financial"}, {"LOWER":  {"FUZZY3": "information"}}],
        [{"LOWER": {"FUZZY": "transaction"}}, {"LOWER": "history"}],
        [{"LOWER": "billing"}, {"LOWER": "information"}],
        [{"LOWER": "billing"}, {"LOWER": "info"}],
        [{"LOWER": "debit"}, {"LOWER": "card"}, {"LOWER": "information"}],
        [{"LOWER": "debit"}, {"LOWER": "card"}, {"LOWER": "info"}],
        [{"LOWER": "debit"}, {"LOWER": "card"}, {"LOWER": "details"}],
        [{"LOWER": "credit"}, {"LOWER": "card"}, {"LOWER": "information"}],
        [{"LOWER": "credit"}, {"LOWER": "card"}, {"LOWER": "info"}],
        [{"LOWER": "credit"}, {"LOWER": "card"}, {"LOWER": "details"}],
        [{"LOWER": "financial"}, {"LOWER": "transactions"}]
    ],
    "Health & Fitness": [
        [{"LOWER": "health"}, {"LOWER": "data"}],
        [{"LOWER": "health"}, {"LOWER": "info"}],
        [{"LOWER": "health"}, {"LOWER": "information"}],
        [{"LOWER": "fitness"}, {"LOWER": "data"}],
        [{"LOWER": "fitness"}, {"LOWER": "info"}],
        [{"LOWER": "fitness"}, {"LOWER": "information"}],
        [{"LOWER": "exercise"}, {"LOWER": "data"}],
        [{"LOWER": "exercise"}, {"LOWER": "info"}],
        [{"LOWER": "exercise"}, {"LOWER": "information"}],
        [{"LOWER": "workout"}, {"LOWER": "data"}],
        [{"LOWER": "workout"}, {"LOWER": "info"}],
        [{"LOWER": "workout"}, {"LOWER": "information"}],
        [{"LOWER": "workout"}, {"LOWER": {"FUZZY": "session"}}],
        [{"LOWER": "dietary"}, {"LOWER": "data"}],
        [{"LOWER": "dietary"}, {"LOWER": "info"}],
        [{"LOWER": "dietary"}, {"LOWER": "information"}],
        [{"LOWER": "nutrition"}, {"LOWER": "data"}],
        [{"LOWER": "nutrition"}, {"LOWER": "info"}],
        [{"LOWER": "nutrition"}, {"LOWER": "information"}],
        [{"LOWER": "heart"}, {"LOWER": "rate"}],
        [{"LOWER": "sleep"}, {"LOWER": "tracking"}],
        [{"LOWER": {"FUZZY": {"IN": ["steps"]}, "NOT_IN": ["steep"]}}, {"LOWER": {"FUZZY": "count"}}],
        [{"LOWER": {"FUZZY": "calorie"}}, {"LOWER": {"FUZZY": "count"}}],
        [{"LOWER": "physical"}, {"LOWER": {"FUZZY3": "activity"}}],
        [{"LOWER": "health"}, {"LOWER": {"FUZZY": "monitoring"}}],
    ],
    "User Content": [
        [{"LOWER": "emails"}], 
        [{"LOWER": "text"}, {"LOWER": "messages"}],
        [{"LOWER": "message"}, {"LOWER": "history"}],
        [{"LOWER": "voice"}, {"LOWER": "mails"}],
        [{"LOWER": "videos"}],
        [{"LOWER": "photos"}],
        [{"LOWER": "gallery"}],
        [{"LOWER": "camera"}],
        [{"LOWER": "microphone"}],
        [{"LOWER": "call"}, {"LOWER": "logs"}],
        [{"LOWER": "call"}, {"LOWER": "records"}],
        [{"LOWER": "mic"}, {"LOWER": "access"}],
        [{"LOWER": "voice"}, {"LOWER": {"FUZZY": "recordings"}}],
        [{"LOWER": "audio"}, {"LOWER": "data"}],
        [{"LOWER": "audio"}, {"LOWER": "files"}],
        [{"LOWER": "music"}, {"LOWER": "files"}],
        [{"LOWER": "gameplay"}, {"LOWER": "content"}],
        [{"LOWER": "uploaded"}, {"LOWER": "media"}],
        [{"LOWER": "uploaded"}, {"LOWER": "files"}],
        [{"LOWER": {"FUZZY": "communication"}}, {"LOWER": "data"}],
        [{"LOWER": {"FUZZY": "communication"}}, {"LOWER": "history"}]
#        [{"LOWER": "other"}, {"LOWER": "user"}, {"LOWER": "content"}]  #Too ambiguos. Exclude.
    ],
    "Contacts": [
        [{"LOWER":  {"FUZZY": {"IN": ["contacts"]}, "NOT_IN": ["contract", "contracts", "contact", "contains", "contacted"]}}],
        [{"LOWER": "contact"}, {"LOWER": {"FUZZY": "list"}}],
        [{"LOWER":  {"FUZZY": "rubric"}}],
        [{"LOWER": "address"}, {"LOWER": {"FUZZY": "book"}}],
        [{"LOWER": "address"}, {"LOWER": {"FUZZY": "list"}}],
        [{"LOWER": "phone"}, {"LOWER": {"FUZZY": "book"}}]
    ],
    "Usage Data": [
        [{"LOWER": "product"}, {"LOWER":  {"FUZZY": "interaction"}}],
        [{"LOWER": "app"}, {"LOWER":  {"FUZZY": "interaction"}}],
        [{"LOWER":  {"FUZZY4": "advertising"}}, {"LOWER": "data"}],
        [{"LOWER":  {"FUZZY4": "advertising"}}, {"LOWER": "information"}],
        [{"LOWER":  "data"}, {"LOWER": "for"}, {"LOWER": {"FUZZY4": "advertising"}}],
        [{"LOWER": "usage"}, {"LOWER": "data"}],
        [{"LOWER": "interaction"}, {"LOWER": "data"}],
        [{"LOWER": "interaction"}, {"LOWER": "info"}],
        [{"LOWER": "user"}, {"LOWER": "engagement"}, {"LOWER": "data"}]
    ],
    "Search History": [
        [{"LOWER": "search"}, {"LOWER": "history"}],
        [{"LOWER": "search"}, {"LOWER": "queries"}],
        [{"LOWER": "search"}, {"LOWER": "terms"}]
    ],
    "Purchases": [
        [{"LOWER": {"FUZZY": "purchase"}}, {"LOWER": "history"}],
        [{"LOWER": "history"}, {"LOWER": "of"}, {"LOWER": {"FUZZY": "purchases"}}],
        [{"LOWER": "purchase"}, {"LOWER": "records"}],
        [{"LOWER": "purchase"}, {"LOWER": "info"}],
        [{"LOWER": "purchase"}, {"LOWER": "information"}],
        [{"LOWER": "purchases"}],
        [{"LOWER": "buying"}, {"LOWER": "history"}],
        [{"LOWER": "order"}, {"LOWER": "history"}]
    ],
    "Browsing History": [
        [{"LOWER": {"FUZZY4": "browsing"}}, {"LOWER": "history"}],
        [{"LOWER": "history"}, {"LOWER": "of"}, {"LOWER": {"FUZZY4": "browser"}}],
        [{"LOWER": "web"}, {"LOWER": "browsing"}, {"LOWER": "history"}],
        [{"LOWER": "internet"}, {"LOWER": "browsing"}, {"LOWER": "history"}],
        [{"LOWER": "online"}, {"LOWER": "browsing"}, {"LOWER": "history"}],
        [{"LOWER": "internet"}, {"LOWER": "history"}]
    ]
}

#Segment spaCy document into paragraphs
#https://gist.github.com/wpm/bf1f2301b98a883b50e903bc3cc86439
def split_paragraphs(document):
    start = 0
    for token in document:
        if token.is_space and token.text.count("\n") > 1:
            yield document[start:token.i].text.strip()
            start = token.i+1
    yield document[start:].text.strip()


#For each data type, save surrounding paragraph of all matches found.
#These are written to a JSON file used to prompt the GPT model
def spacy_nlp(app_id, text):
    nlp = spacy.load("en_core_web_sm")
    
    matcher = Matcher(nlp.vocab)
    for category, data_types in patterns.items():
        for data_type in data_types:
            matcher.add(category, [data_type])

    doc = nlp(text)
    
    para_list = list(split_paragraphs(doc))        
    
    para_matches = {category: [] for category in patterns.keys()}
    
    for i, para in enumerate(para_list):
        #Stand alone processing
        para_doc = nlp(para)
        matches = matcher(para_doc)
        for match_id, start, end in matches:
            category = nlp.vocab.strings[match_id]
            if para not in para_matches[category]:
                para_matches[category].append(para)

    json_path = OUTPUT_FILE
    
    if not COLLECT_PARAGRAPHS:
        category_counts = {category: 0 for category in patterns.keys()}
        for match_id, start, end in matcher(doc):
            category = nlp.vocab.strings[match_id]
            category_counts[category] += 1
        json_path = COLLECTION_COUNTS_FILE
    
    #Load data, update it, save it:
    try:
    ...
    #Update JSON with new paragraphs
    if COLLECT_PARAGRAPHS:
        if app_id in data:
            for category, paragraphs in para_matches.items():
                if category in data[app_id]:
                    data[app_id][category].extend(paragraphs)
                else:
                    data[app_id][category] = paragraphs
        else:
            data[app_id] = para_matches
    else:
        #Update JSON with new counts
        if app_id in data:
            for category, count in category_counts.items():
                if category in data[app_id]:
                    data[app_id][category] += count
                else:
                    data[app_id][category] = count
        else:
            data[app_id] = category_counts
...
#SAMPLE POLICY FROM: https://www.whatsapp.com/legal/privacy-policy
#spacy_nlp("whatsapp", """
#
